# I/O Secret [![Documentation](https://img.shields.io/docsrs/io-secret)](https://docs.rs/io-secret/latest/io_secret) [![Matrix](https://img.shields.io/matrix/pimalaya:matrix.org?color=success&label=chat)](https://matrix.to/#/#pimalaya:matrix.org)

Set of **I/O-free** Rust coroutines to retrieve secrets from different sources, based on [io-process](https://github.com/pimalaya/io-process) and [io-keyring](https://github.com/pimalaya/io-keyring).
...
*See available coroutines at [./src/coroutines](https://github.com/pimalaya/io-secret/tree/master/src/coroutines).*

### Runtime

A runtime contains all the I/O logic, and is responsible for **processing I/O requests** emitted by coroutines.

*See available runtimes at [io-process](https://github.com/pimalaya/io-process/tree/master/src/runtimes) and [io-keyring](https://github.com/pimalaya/io-keyring/tree/master/src/runtimes).*
...
*See complete example at [./examples/read](https://github.com/pimalaya/io-secret/blob/master/examples/read.rs).*
